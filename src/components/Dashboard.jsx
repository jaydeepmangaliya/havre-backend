...
const Dashboard = () => {
  ...
  const chartSalesData = salesData || fallbackSalesData;
  const last30Days = last30DaysData || fallbackLast30Days;
  const productSales = productDistribution || fallbackProductSales;
  ...
  return (
    <Spin spinning={statsLoading} tip="Loading dashboard...">
      <div style={{ padding: isMobile ? '16px' : '24px' }}>
        <Title level={2} style={{ marginBottom: '24px', fontWeight: 600 }}>
          Dashboard
        </Title>
